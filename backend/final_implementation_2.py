...
if __name__ == "__main__":
    inputvideopath = input("Enter path to the input video: ")
    outputvideopath = "output_with_narration.mp4"
    process_video_with_audio(inputvideopath, outputvideopath, frame_skip=5)
